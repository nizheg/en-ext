...
$(function() {	
	...
	var last_answer = $('ul.history li:contains("' + localStorage['username'] + '"):nth(0)').html();
	var done_bonus = $('div.content h3.color_correct').size();
	var bonus = $('div.content h3.color_bonus').size();
	chrome.runtime.sendMessage({"title" : title, "sectors_info" : sectors_info, "sectors" : sectors, "corrects": corrects, "last_answer" : last_answer, "done_bonus_count" : done_bonus, "bonus_count" : bonus}, 
		function(response) {}
	);
});
