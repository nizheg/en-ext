...
$(function() {	
	...
	chrome.runtime.sendMessage({"title" : title, "sectors_info" : sectors_info, "sectors" : sectors, "corrects": corrects, "last_answer" : last_answer.html(), "last_code" : last_code, "done_bonus_count" : done_bonus, "bonus_count" : bonus}, 
		function(response) {}
	);
});
